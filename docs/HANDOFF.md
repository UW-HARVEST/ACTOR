...
| 19 | **`validate-translations` red for six weeks, so CI proves nothing** | `docs/prs/spec-19.md` | ready; cheap, and it restores meaning to a red check |
...
**So do not read a green `tests` as "CI validated this."** `docs/prs/spec-19.md` moves the matrix to
