...
Your task:
1. Read Cargo.toml and c_src/CMakeLists.txt to understand the build.
2. Run `cargo check` and fix all compile errors before proceeding.
3. Build the C code as a shared library.
